...
export default function App() {
  ...
  // Releases are published only after review; older manifests may store that date
  // at release level instead of on each language guide.
  const reviewDate = currentGuide.reviewedAt || release.releasedAt;
