...
const labels = {
  en: { title: 'Ask Krishi', subtitle: 'Answers from your farming guide', latestSubtitle: 'Model generated answer using the guide', placeholder: 'Ask about crops, soil, water or schemes...', welcome: 'Hello. Ask me about farming in Dakshina Kannada.', greeting: 'Hello. How can I help with your farm today?', grounded: 'Grounded in your selected guide', latest: 'Guide + model answer', guide: 'Guide answer', sources: 'Source', empty: 'I could not find a close match in this guide. Try asking about a crop, season, soil, drainage, pests, schemes or markets.', latestError: 'Guide + model answer is unavailable. Choose Guide answer for an answer from the local guide, or start the API server and check its configuration.', close: 'Close assistant' },
  kn: { title: 'ಕೃಷಿಯನ್ನು ಕೇಳಿ', subtitle: 'ನಿಮ್ಮ ಕೃಷಿ ಮಾರ್ಗದರ್ಶಿಯಿಂದ ಉತ್ತರಗಳು', latestSubtitle: 'ಮಾರ್ಗದರ್ಶಿಯನ್ನು ಬಳಸಿ ಮಾಡೆಲ್ ರಚಿಸಿದ ಉತ್ತರ', placeholder: 'ಬೆಳೆ, ಮಣ್ಣು, ನೀರು ಅಥವಾ ಯೋಜನೆಗಳ ಬಗ್ಗೆ ಕೇಳಿ...', welcome: 'ನಮಸ್ಕಾರ. ದಕ್ಷಿಣ ಕನ್ನಡದ ಕೃಷಿಯ ಬಗ್ಗೆ ಕೇಳಿ.', greeting: 'ನಮಸ್ಕಾರ. ಇಂದು ನಿಮ್ಮ ಕೃಷಿಗೆ ನಾನು ಹೇಗೆ ಸಹಾಯ ಮಾಡಲಿ?', grounded: 'ನೀವು ಆಯ್ಕೆ ಮಾಡಿದ ಮಾರ್ಗದರ್ಶಿ ಆಧಾರಿತ', latest: 'ಮಾರ್ಗದರ್ಶಿ + ಮಾಡೆಲ್ ಉತ್ತರ', guide: 'ಮಾರ್ಗದರ್ಶಿ ಉತ್ತರ', sources: 'ಮೂಲ', empty: 'ಈ ಮಾರ್ಗದರ್ಶಿಯಲ್ಲಿ ಹತ್ತಿರದ ಉತ್ತರ ಸಿಗಲಿಲ್ಲ. ಬೆಳೆ, ಋತು, ಮಣ್ಣು, ಒಳಚರಂಡಿ, ಕೀಟ, ಯೋಜನೆ ಅಥವಾ ಮಾರುಕಟ್ಟೆ ಬಗ್ಗೆ ಕೇಳಿ.', latestError: 'ಮಾರ್ಗದರ್ಶಿ + ಮಾಡೆಲ್ ಉತ್ತರ ಈಗ ಲಭ್ಯವಿಲ್ಲ. ಸ್ಥಳೀಯ ಮಾರ್ಗದರ್ಶಿಯ ಉತ್ತರಕ್ಕಾಗಿ ಮಾರ್ಗದರ್ಶಿ ಉತ್ತರವನ್ನು ಆಯ್ಕೆಮಾಡಿ, ಅಥವಾ API ಸರ್ವರ್ ಮತ್ತು ಅದರ ಸಂರಚನೆಯನ್ನು ಪರಿಶೀಲಿಸಿ.', close: 'ಸಹಾಯಕನನ್ನು ಮುಚ್ಚಿ' },
  tcy: { title: 'ಕೃಷಿನ್ ಕೇಳಲೆ', subtitle: 'ನಿಕ್ಲೆನ ಮಾರ್ಗದರ್ಶಿರ್ದ್ ಉತ್ತರ', latestSubtitle: 'ಮಾರ್ಗದರ್ಶಿನ್ ಬಳಸೊಂದು ಮಾಡೆಲ್ ಮಲ್ತಿನ ಉತ್ತರ', placeholder: 'ಬೆಳೆ, ಮಣ್ಣ್, ನೀರ್ ಅತ್ತ್ಂಡ ಯೋಜನೆ ಬಗ್ಗೆ ಕೇಳಲೆ...', welcome: 'ನಮಸ್ಕಾರ. ದಕ್ಷಿಣ ಕನ್ನಡದ ಕೃಷಿದ ಬಗ್ಗೆ ಕೇಳಲೆ.', greeting: 'ನಮಸ್ಕಾರ. ಈ ದಿನ ಉಮೆರ್ ಕೃಷಿಗ್ ಯಾನ್ ಎಂಚ ಸಹಾಯ ಮಲ್ಪೊಲಿ?', grounded: 'ಆಯ್ಕೆ ಮಲ್ತಿನ ಮಾರ್ಗದರ್ಶಿ ಆಧಾರಿತ', latest: 'ಮಾರ್ಗದರ್ಶಿ + ಮಾಡೆಲ್ ಉತ್ತರ', guide: 'ಮಾರ್ಗದರ್ಶಿ ಉತ್ತರ', sources: 'ಮೂಲ', empty: 'ಈ ಮಾರ್ಗದರ್ಶಿಡ್ ಹತ್ತಿರದ ಉತ್ತರ ಸಿಕ್ಕಿಜಿ. ಬೆಳೆ, ಋತು, ಮಣ್ಣ್, ಡ್ರೈನೇಜ್, ಕೀಟ, ಯೋಜನೆ ಅತ್ತ್ಂಡ ಮಾರುಕಟ್ಟೆ ಬಗ್ಗೆ ಕೇಳಲೆ.', latestError: 'ಮಾರ್ಗದರ್ಶಿ + ಮಾಡೆಲ್ ಉತ್ತರ ಇತ್ತ್ಂಡ ಲಭ್ಯ ಆಪುಜಿ. ಸ್ಥಳೀಯ ಮಾರ್ಗದರ್ಶಿರ್ದ ಉತ್ತರೊಕ್ ಮಾರ್ಗದರ್ಶಿ ಉತ್ತರ ಆಯ್ಕೆ ಮಲ್ಪುಲೆ, ಅತ್ತ್ಂಡ API ಸರ್ವರ್ ಪನ್ಪಿನ ಸೆಟ್ಟಿಂಗ್ ಪರಿಶೀಲಿಸಲೆ.', close: 'ಸಹಾಯಕನ್ ಮುಚ್ಚಲೆ' }
};
